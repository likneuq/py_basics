...
print(f"小披萨面积：{small_area} cm, 成本：{small_cost:.1f} 元")
print(f"中披萨面积：{medium_area} cm, 成本：{medium_cost:.1f} 元")
print(f"大披萨面积：{large_area} cm, 成本：{large_cost:.1f} 元")
